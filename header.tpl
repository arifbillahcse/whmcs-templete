...
<div id="spinner-area">
  <div class="spinner">
    ...
    <div class="spinner-txt">Hostorioi...</div>
  </div>
</div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12 col-md-12">
          <div class="wrapper">
            <h1 class="heading">Welcome to Hostorio</h1>
            <h3 class="subheading">Best Hosting Provider Company. Speed is our first priority</h3>
          </div>
        </div>
      </div>
    </div>
